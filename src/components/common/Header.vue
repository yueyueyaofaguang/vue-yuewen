    ...
    <nav class="header">
        ...
        <div class="container">
            ...
            <ul class="container-right-ul">
                ...
                <li @click="navigateTo('publish')" class="container-left-li">提问</li>
                <li id="user" @click="toggleSubMenu('user','turnlg')" :class="subMenuList.user.turnlg ? 'menu-item-active' : 'container-right-li'">
                    蝉蝉<span class="el-icon-caret-bottom"></span>
        ...
        <transition name="dropdown-fade-show">
            <div v-show="dropDownShow" class="dropdown">
                <ul>
                    ...
                    <li>须知</li>
                    <li>提问</li>
                    <li @click="toggleSubMenu('user','turnsm')">
                        蝉蝉<span class="el-icon-caret-bottom"></span>
